...
import { IBridge, stopBridge, tokenType, ISession } from '@energyweb/ocn-bridge';
...
describe('ChargeService', () => {
  ...
  describe('fetch session confimation', () => {
    it('should fetch session confirmation', async () => {
      ...
      const result = await chargeService.fetchSessionConfirmation('7e42736a-4287-4c1e-b883-9ff03ea622b5');
